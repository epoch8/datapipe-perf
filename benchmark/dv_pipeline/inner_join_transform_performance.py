...
from benchmark.dv_pipeline.pipeline_with_inner_join import get_app
...
def main(benchmark_settings: BenchmarkSettings = benchmark_settings) -> None:
    ...
    try:
        source_1 = app.ds.get_table("inner_source_1")
        source_2 = app.ds.get_table("inner_source_2")
        target = app.ds.get_table("inner_target")
